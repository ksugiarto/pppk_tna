...
class TeacherSubjectsControllerTest < ActionController::TestCase
  ...
  test "should create teacher_subject" do
    assert_difference('TeacherSubject.count') do
      post :create, teacher_subject: { is_competent: @teacher_subject.is_competent, subject_id: @teacher_subject.subject_id, teacher_id: @teacher_subject.teacher_id }
    end
  ...
  test "should update teacher_subject" do
    put :update, id: @teacher_subject, teacher_subject: { is_competent: @teacher_subject.is_competent, subject_id: @teacher_subject.subject_id, teacher_id: @teacher_subject.teacher_id }
    assert_redirected_to teacher_subject_path(assigns(:teacher_subject))
  end
